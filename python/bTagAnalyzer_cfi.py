...
bTagAnalyzer = cms.EDAnalyzer("BTagAnalyzer",
    ...
    deepFlavourNegTagInfos = cms.string('pfNegativeDeepFlavour'),
    deepFlavourTagInfos = cms.string('pfDeepFlavour'),
    pfDeepFlavour = cms.string('pfDeepFlavour'),
    deepCSVTagInfos = cms.string('pfDeepCSV'),
    pfDeepCSVNegative = cms.string('pfDeepCSVNegative'),
    deepCSVNegTagInfos = cms.string('pfNegativeDeepCSV'),
